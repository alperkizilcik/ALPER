...
public class HataliloginTest {
  ...
  public void hatalilogin() {
    ...
    {
      WebElement element = driver.findElement(By.linkText("Kemer"));
    ...
    driver.findElement(By.cssSelector("#login-form > .alert")).click();
    assertThat(driver.findElement(By.cssSelector("#login-form > .alert")).getText(), is("Kullanıcı adı veya şifre hatalı. Giriş yapılamıyor."));
  }
}
